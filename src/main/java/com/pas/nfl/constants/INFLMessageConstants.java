...
public interface INFLMessageConstants
{
	...
	public static String SEED_INVALID="playoffsSetupForm.SeedInvalid";
	public static String INCORRECT_NUMBER_OF_SEEDS="playoffsSetupForm.IncorrectTotalSeeds";
	public static String SCORE_INVALID="scoresListForm.ScoreInvalid";
	public static String SCORE_MISSING="scoresListForm.ScoreMissing";
